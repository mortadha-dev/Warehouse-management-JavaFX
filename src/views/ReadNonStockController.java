 ...
 * @author tayssir
 */
public class ReadNonStockController implements Initializable {

    @FXML
    private Pane hayhay;
    @FXML
    private TableView<Produit> tabnnstock;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       tabnnstock.setItems(null);
        tabnnstock.setItems((FXCollections.observableArrayList(list))); 
